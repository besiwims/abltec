...
const defaultMeta = {
  title: 'ABL Tech Pty Ltd',
  siteName: 'ABL TECH',
  description:
    'ABL Tech is an Australian based IT Consulting and Media Agency company with an aim to bring global quality affordable services and products',
  url: 'https://abltech.com.au',
  type: 'website',
  robots: 'follow, index',
...
const SeoHead = (props) => {
  ...
  return (
    <Head>
      ...
      {/* Windows 8 app icon */}
      <meta name='msapplication-TileColor' content='#048025' />
      <meta
        name='msapplication-TileImage'
        content='/favicon/ms-icon-144x144.png'
      />
      {/* Accent color on supported browser */}
      <meta name='theme-color' content='#048025' />
    </Head>
  );
};
